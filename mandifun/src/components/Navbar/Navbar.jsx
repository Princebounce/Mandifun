...
const Navbar = () => {
  ...
  return (
    <div className={`shadow-md ${theme === "light" ? "bg-white" : "bg-gray-900"} dark:${theme === "light" ? "text-black" : "text-white"} duration-200 relative z-40`}>
      {/* upper Navbar */}
          ...
          <div className="flex justify-between items-center gap-4">
            <div className="relative group hidden sm:block">
              <input
                type="text"
                placeholder="search"
                className="w-[200px] sm:w-[200px] group-hover:w-[300px] transition-all duration-300 rounded-full border border-gray-300 px-2 py-1 focus:outline-none focus:border-1 focus:border-primary dark:border-primary dark:bg-gray-600"
              />
